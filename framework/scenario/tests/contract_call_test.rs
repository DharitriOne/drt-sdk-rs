use drt_sc::api::DCT_MULTI_TRANSFER_FUNC_NAME;
use drt_sc_scenario::scenario_model::ScCallStep;
use num_traits::Zero;
...
fn test_contract_call_multi_dct() {
    let tx = ScCallStep::new()
        ...
        .dct_transfer("str:WREWA-abcdef", 0, 10u32)
    ...
    assert_eq!(
        ...
        "MultiDCTNFTTransfer@726563697069656e745f5f5f5f5f5f5f5f5f5f5f5f5f5f5f5f5f5f5f5f5f5f5f@02@57524557412d616263646566@@0a@555344432d616263646566@@0b",
    );
