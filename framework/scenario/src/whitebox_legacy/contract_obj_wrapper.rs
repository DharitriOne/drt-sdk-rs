...
use drt_chain_scenario_format::interpret_trait::InterpretableFrom;
use drt_chain_vm::{
    tx_mock::{TxContext, TxContextStack, TxFunctionName, TxResult},
    types::VMAddress,
};
use drt_sc::types::{BigUint, H256};
use num_traits::Zero;
...
impl BlockchainStateWrapper {
    ...
    pub fn set_dct_balance(
        ...
        self.world
            .set_dct_balance(address, token_id, BigUint::from(balance));
    }
    ...
    pub fn set_dct_local_roles(
        ...
        self.world.set_dct_local_roles(address, token_id, roles);
    }
