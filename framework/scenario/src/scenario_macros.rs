...
macro_rules! managed_token_id {
    ($bytes:expr) => {{
        drt_sc::types::TokenIdentifier::from_dct_bytes($bytes)
    }};
}
...
macro_rules! managed_token_id_wrapped {
    ($bytes:expr) => {{
        let ___dct_token_id___ = drt_sc::types::TokenIdentifier::from_dct_bytes($bytes);
        drt_sc::types::RewaOrDctTokenIdentifier::dct(___dct_token_id___)
    }};
}
...
macro_rules! managed_rewa_token_id {
    () => {{
        drt_sc::types::RewaOrDctTokenIdentifier::rewa()
    }};
}
