...
use crate::drt_sc::types::{Address, TestAddress, TestSCAddress};
...
impl AddressValue {
    ...
    pub fn to_vm_address(&self) -> drt_chain_vm::types::VMAddress {
...
where
    Env: TxEnv,
{
    fn annotation(&self, _env: &Env) -> drt_sc::types::ManagedBuffer<Env::Api> {
