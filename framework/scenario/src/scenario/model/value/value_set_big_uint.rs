...
use crate::drt_sc::api::ManagedTypeApi;
...
impl<M: ManagedTypeApi> From<crate::drt_sc::types::BigUint<M>> for BigUintValue {
    fn from(from: crate::drt_sc::types::BigUint<M>) -> Self {
...
impl<M: ManagedTypeApi> From<crate::drt_sc::types::AnnotatedRewaPayment<M>>
    for BigUintValue
{
    fn from(from: crate::drt_sc::types::AnnotatedRewaPayment<M>) -> Self {
        BigUintValue {
