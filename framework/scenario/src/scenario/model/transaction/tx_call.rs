use crate::{
    api::StaticApi,
    drt_sc::types::{ContractCall, DctTokenPayment},
...
use super::{tx_interpret_util::interpret_rewa_value, TxDCT};
...
impl TxCall {
    ...
    #[allow(deprecated)]
    pub fn to_contract_call(&self) -> drt_sc::types::ContractCallWithRewa<StaticApi, ()> {
        let mut contract_call = drt_sc::types::ContractCallWithRewa::new(
            (&self.to.value).into(),
