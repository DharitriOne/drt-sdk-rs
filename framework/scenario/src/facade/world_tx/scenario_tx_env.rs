use drt_chain_scenario_format::interpret_trait::InterpreterContext;
use drt_sc::types::{ManagedAddress, ManagedBuffer, TxEnv, H256};
...
impl TxEnv for ScenarioTxEnvData {
    ...
    fn default_gas_annotation(&self) -> drt_sc::types::ManagedBuffer<Self::Api> {
