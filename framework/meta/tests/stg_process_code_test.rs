use drt_sc_meta::cmd::scen_test_gen::{format_test_fn_go, process_code, DEFAULT_SETUP_GO};

const GO_TEST_1: &str = r#"use drt_sc_scenario::*;
...
const GO_TEST_0_1_2: &str = r#"use drt_sc_scenario::*;
