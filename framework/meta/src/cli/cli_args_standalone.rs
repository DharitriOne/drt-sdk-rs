...
use drt_sc_meta_lib::cli::{CliArgsToRaw, ContractCliAction};
...
#[command(
    ...
    about,
    after_help = "
The DharitriOne smart contract Meta crate can be used in two ways:
...
pub enum InstallCommand {
    ...
    #[command(about = "Installs the `drt-scenario-go` tool")]
