use crate::{
    ...
    types::{
        system_proxy::DCTSystemSCProxy, DCTSystemSCAddress, RewaPayment, FunctionCall,
...
use crate::{
    ...
    types::{
        ...
        BigUint, CallbackClosure, DctTokenData, DctTokenPayment, DctTokenType, ManagedAddress,
    ...
    SA: StorageMapperApi + CallTypeApi,
{
    ...
    fn meta_issue(
        ...
        Tx::new_tx_from_sc()
            .to(DCTSystemSCAddress)
            .typed(DCTSystemSCProxy)
            .register_meta_dct(issue_cost, &token_display_name, &token_ticker, properties)
    }
