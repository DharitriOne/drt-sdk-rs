...
use crate::{
    ...
    storage::{self},
    types::{
        BackTransfers, BigUint, CodeMetadata, RewaOrDctTokenIdentifier, DctLocalRoleFlags,
    ...
    A: BlockchainApi + ManagedTypeApi + ErrorApi,
{
    ...
    #[inline]
    pub fn get_sc_balance(&self, token: &RewaOrDctTokenIdentifier<A>, nonce: u64) -> BigUint<A> {
