...
use super::RewaOrDctTokenIdentifier;
...
impl<M: ManagedTypeApi> PartialEq<RewaOrDctTokenIdentifier<M>> for TokenIdentifier<M> {
    #[inline]
    fn eq(&self, other: &RewaOrDctTokenIdentifier<M>) -> bool {
