...
impl<M: ManagedTypeApi> ManagedVecItem for DctTokenPaymentMultiValue<M> {
    type PAYLOAD = <DctTokenPayment<M> as ManagedVecItem>::PAYLOAD;
...
impl<M> TypeAbiFrom<Self> for DctTokenPaymentMultiValue<M> where M: ManagedTypeApi {}
    ...
    M: ManagedTypeApi,
{
    ...
    fn type_name_rust() -> TypeName {
        "DctTokenPaymentMultiValue<$API>".into()
    }
