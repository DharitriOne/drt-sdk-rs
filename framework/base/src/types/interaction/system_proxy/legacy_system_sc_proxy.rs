...
use crate::{
    ...
    types::{
        BigUint, ContractCall, ContractCallNoPayment, ContractCallWithRewa, DCTSystemSCAddress,
        DctLocalRole, DctTokenType, ManagedAddress, ManagedBuffer, TokenIdentifier,
    },
};
...
#[deprecated(
    since = "0.49.0",
    note = "There is a new `DCTSystemSCProxy`, which uses the new proxy model."
)]
    ...
    SA: CallTypeApi + 'static,
{
    ...
    fn issue(
        ...
        let mut contract_call =
            ContractCallWithRewa::new(dct_system_sc_address, endpoint_name, issue_cost);
