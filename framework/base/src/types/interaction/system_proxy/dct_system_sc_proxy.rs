...
use crate::{
    api::CallTypeApi,
    types::{
        BigUint, RewaPayment, DctLocalRole, DctTokenType, FunctionCall, ManagedAddress,
...
/// The specific `Tx` type produces by the issue operations of the DCTSystemSCProxy.
...
pub struct DCTSystemSCProxy;

impl<Env, From, To, Gas> TxProxyTrait<Env, From, To, Gas> for DCTSystemSCProxy
where
    Env: TxEnv,
    From: TxFrom<Env>,
    To: TxTo<Env>,
    Gas: TxGas<Env>,
{
    type TxProxyMethods = DCTSystemSCProxyMethods<Env, From, To, Gas>;

    fn proxy_methods(self, tx: Tx<Env, From, To, (), Gas, (), ()>) -> Self::TxProxyMethods {
        DCTSystemSCProxyMethods { wrapped_tx: tx }
    }
}

/// Method container of the DCT system smart contract proxy.
pub struct DCTSystemSCProxyMethods<Env, From, To, Gas>
where
    Env: TxEnv,
    From: TxFrom<Env>,
    To: TxTo<Env>,
...
impl<Env, From, To, Gas> DCTSystemSCProxyMethods<Env, From, To, Gas>
where
    Env: TxEnv,
    From: TxFrom<Env>,
    To: TxTo<Env>,
