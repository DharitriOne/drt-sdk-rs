mod tx_payment_rewa;
mod tx_payment_rewa_or_dct;
mod tx_payment_rewa_or_dct_refs;
mod tx_payment_rewa_or_multi_dct;
mod tx_payment_rewa_or_multi_dct_ref;
mod tx_payment_rewa_value;
mod tx_payment_multi_dct;
mod tx_payment_none;
mod tx_payment_not_payable;
mod tx_payment_single_dct;
mod tx_payment_single_dct_ref;
mod tx_payment_single_dct_triple;

pub use tx_payment_rewa::{Rewa, RewaPayment};
pub use tx_payment_rewa_value::TxRewaValue;
pub use tx_payment_multi_dct::TxPaymentMultiDct;
pub use tx_payment_not_payable::NotPayable;

use crate::{
    api::ManagedTypeApi,
    types::{BigUint, ManagedAddress, ManagedBuffer, MultiDctPayment},
};
...
where
    Env: TxEnv,
{
    /// Returns true if payment indicates transfer of either non-zero REWA or DCT amounts.
    ...
    /// Converts an DCT call to a built-in function call, if necessary.
    ...
    Api: ManagedTypeApi,
{
    ...
    pub multi_dct: MultiDctPayment<Api>,
}
