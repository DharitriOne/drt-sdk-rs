...
use crate::{
    ...
    api::{
        CallTypeApi, ManagedTypeApi, DCT_MULTI_TRANSFER_FUNC_NAME, DCT_NFT_TRANSFER_FUNC_NAME,
        DCT_TRANSFER_FUNC_NAME,
    },
    types::{
        ContractCallNoPayment, DctTokenPayment, DctTokenPaymentRefs, ManagedAddress,
    ...
    Api: ManagedTypeApi,
{
    ...
    pub(crate) fn convert_to_single_transfer_fungible_call(
        self,
        payment: DctTokenPaymentRefs<'_, Api>,
    ) -> FunctionCall<Api> {
    ...
    pub(crate) fn convert_to_multi_transfer_dct_call(
        self,
        to: &ManagedAddress<Api>,
