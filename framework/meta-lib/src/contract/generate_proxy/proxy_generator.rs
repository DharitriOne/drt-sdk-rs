...
const PRELUDE: &str = "// Code generated by the drt-sc proxy generator. DO NOT EDIT.
...
const IMPORTS: &str = "use drt_sc::proxy_imports::*;";
...
where
    ...
    fn adjust_type_name_with_env_api(&mut self, original_rust_name: &str) -> String {
        self.clean_paths(
            &original_rust_name
                .replace("drt_sc::api::uncallable::UncallableApi", "Env::Api")
                .replace("$API", "Env::Api"),
        )
    }
    ...
    fn adjust_type_name_with_api(&mut self, original_rust_name: &str) -> String {
        self.clean_paths(
            &original_rust_name
                .replace("drt_sc::api::uncallable::UncallableApi", "Api")
                .replace("$API", "Api"),
        )
    }
...
#[cfg(test)]
pub mod tests {
    use drt_sc::abi::{BuildInfoAbi, ContractAbi, ContractCrateBuildAbi, FrameworkBuildAbi};
