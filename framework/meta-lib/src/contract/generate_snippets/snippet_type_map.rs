...
fn init_rust_types_map() -> HashMap<&'static str, RustTypeString> {
    ...
    m.insert(
        ...
        RustTypeString {
            type_name: "RewaOrDctTokenIdentifier".to_string() + STATIC_API_SUFFIX,
            default_value_expr: "RewaOrDctTokenIdentifier::dct(&b\"\"[..])".to_string(),
            contains_custom_types: false,
        },
    );
    ...
    m.insert(
        ...
        RustTypeString {
            type_name: "RewaOrDctTokenPayment".to_string() + STATIC_API_SUFFIX,
            default_value_expr: "RewaOrDctTokenPayment::new(
