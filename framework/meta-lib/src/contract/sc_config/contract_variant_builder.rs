...
fn build_contract_abi(builder: ContractVariantBuilder, original_abi: &ContractAbi) -> ContractAbi {
    ...
    for endpoint_abi in builder.collected_endpoints {
        match endpoint_abi.endpoint_type {
            drt_sc::abi::EndpointTypeAbi::Init => constructors.push(endpoint_abi),
            drt_sc::abi::EndpointTypeAbi::Upgrade => upgrade_constructors.push(endpoint_abi),
            drt_sc::abi::EndpointTypeAbi::Endpoint => endpoints.push(endpoint_abi),
            drt_sc::abi::EndpointTypeAbi::PromisesCallback => {
