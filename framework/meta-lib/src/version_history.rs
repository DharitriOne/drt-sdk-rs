...
pub const LAST_VERSION: FrameworkVersion = framework_version!(0.0.2);
...
pub const LOWER_VERSION_WITH_TEMPLATE_TAG: FrameworkVersion = framework_version!(0.0.2);
pub const LOWER_VERSION_WITH_AUTOGENERATED_JSON: FrameworkVersion = framework_version!(0.0.2);
pub const LOWER_VERSION_WITH_AUTOGENERATED_WASM: FrameworkVersion = framework_version!(0.0.2);
...
pub mod tests {
    ...
    fn framework_version_display_test() {
        assert_eq!(format!("Framework: {}", VERSIONS[0]), "Framework: 0.0.2");
    }

    #[test]
    fn template_versions_test() {
        assert!(validate_template_tag("0.0.2"));
    }
    ...
    fn find_version_by_str_test() {
        let version = find_version_by_str("0.0.2");
        match version {
