...
pub const LAST_VERSION: FrameworkVersion = framework_version!(0.0.3);
...
pub const LOWER_VERSION_WITH_TEMPLATE_TAG: FrameworkVersion = framework_version!(0.0.3);
pub const LOWER_VERSION_WITH_AUTOGENERATED_JSON: FrameworkVersion = framework_version!(0.0.3);
pub const LOWER_VERSION_WITH_AUTOGENERATED_WASM: FrameworkVersion = framework_version!(0.0.3);
...
pub mod tests {
    ...
    fn template_versions_test() {
        assert!(validate_template_tag("0.0.3"));
    }
