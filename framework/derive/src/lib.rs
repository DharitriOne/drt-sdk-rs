...
pub fn const_managed_decimal(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let expanded = quote! {
        drt_sc::types::ManagedDecimal::<<Self as ContractBase>::Api, drt_sc::types::ConstDecimals<#decimals>>::const_decimals_from_raw(drt_sc::types::BigUint::from(#raw_int))
    };
...
pub fn managed_decimal(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let expanded = quote! {
        drt_sc::types::ManagedDecimal::<<Self as ContractBase>::Api, usize>::from_raw_units(drt_sc::types::BigUint::from(#raw_int), #decimals)
    };
...
pub fn debug_const_managed_decimal(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let expanded = quote! {
        drt_sc::types::ManagedDecimal::<drt_sc_scenario::imports::StaticApi, drt_sc::types::ConstDecimals<#decimals>>::const_decimals_from_raw(drt_sc::types::BigUint::from(#raw_int))
    };
...
pub fn debug_managed_decimal(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let expanded = quote! {
        drt_sc::types::ManagedDecimal::<drt_sc_scenario::imports::StaticApi, usize>::from_raw_units(drt_sc::types::BigUint::from(#raw_int), #decimals)
    };
