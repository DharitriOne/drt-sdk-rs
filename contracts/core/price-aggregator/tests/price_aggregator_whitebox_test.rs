...
const PRICE_AGGREGATOR_PATH_EXPR: &str = "drtsc:output/drt-price-aggregator-sc.drtsc.json";
...
fn world() -> ScenarioWorld {
    ...
    blockchain.register_contract(
        ...
        drt_price_aggregator_sc::ContractBuilder,
    );
...
fn test_price_aggregator_submit() {
    ...
    let price_aggregator_whitebox = WhiteboxContract::new(
        ...
        drt_price_aggregator_sc::contract_obj,
    );
