...
const MULTISIG_PATH_EXPR: &str = "drtsc:output/multisig.drtsc.json";
...
fn call_propose(
    ...
    world.whitebox_call_check(
        ...
        ScCallStep::new()
            ...
            .rewa_value(amount_rust_biguint)
            .no_expect(),
        |sc| {
...
fn test_transfer_execute_to_user() {
    ...
    world.check_state_step(CheckStateStep::new().put_account(
        ...
        CheckAccount::new().balance(REWA_AMOUNT.to_string().as_str()),
    ));
...
fn test_transfer_execute_sc_all() {
    ...
    const ADDER_PATH_EXPR: &str = "drtsc:test-contracts/adder.drtsc.json";
...
fn test_deploy_and_upgrade_from_source() {
    ...
    const FACTORIAL_PATH_EXPR: &str = "drtsc:test-contracts/factorial.drtsc.json";
