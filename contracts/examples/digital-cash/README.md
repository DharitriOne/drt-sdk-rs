...
The basic idea of DharitriOne Digital Cash is that ONE link can hold information (DCT tokens, REWA) on chain, this link can be sent from one person to another, there is no need to hold any wallet to receive, consume and send it forward to another person.
