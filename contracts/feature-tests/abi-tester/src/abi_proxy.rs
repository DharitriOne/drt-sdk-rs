    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn dct_local_role(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, DctLocalRole> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("dct_local_role")
            .original_result()
    }

    pub fn dct_token_payment(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, DctTokenPayment<Env::Api>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("dct_token_payment")
            .original_result()
    }

    pub fn dct_token_data(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, DctTokenData<Env::Api>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("dct_token_data")
            .original_result()
    }
