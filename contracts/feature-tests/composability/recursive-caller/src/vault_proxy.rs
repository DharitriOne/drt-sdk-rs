    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn accept_funds_echo_payment(
        self,
    ) -> TxTypedCall<Env, From, To, (), Gas, MultiValue2<BigUint<Env::Api>, MultiValueEncoded<Env::Api, DctTokenPaymentMultiValue<Env::Api>>>> {
        self.wrapped_tx
            .raw_call("accept_funds_echo_payment")
            .original_result()
    }

    pub fn accept_funds_single_dct_transfer(
        self,
    ) -> TxTypedCall<Env, From, To, (), Gas, ()> {
        self.wrapped_tx
            .raw_call("accept_funds_single_dct_transfer")
            .original_result()
    }
    ...
    pub fn retrieve_funds<
        Arg0: ProxyArg<RewaOrDctTokenIdentifier<Env::Api>>,
        Arg1: ProxyArg<u64>,
