...
const DCT_TRANSFER_STRING: &str = "DCTTransfer";
const SECOND_CONTRACT_ACCEPT_DCT_PAYMENT: &str = "acceptDctPayment";
const SECOND_CONTRACT_REJECT_DCT_PAYMENT: &str = "rejectDctPayment";
...
pub trait FirstContract {
    ...
    fn transfer_to_second_contract_rejected_with_transfer_and_execute(&self) {
        ...
        self.tx()
            ...
            .gas(gas_left)
            .raw_call(SECOND_CONTRACT_REJECT_DCT_PAYMENT)
            .single_dct(&expected_token_identifier, 0u64, &dct_value)
            .transfer_execute();
    }
    ...
    fn transfer_to_second_contract_full_with_transfer_and_execute(&self) {
        ...
        self.tx()
            .to(&second_contract_address)
            .gas(gas_left)
            .raw_call(SECOND_CONTRACT_ACCEPT_DCT_PAYMENT)
            .single_dct(&expected_token_identifier, 0u64, &dct_value)
            .transfer_execute();
    }
