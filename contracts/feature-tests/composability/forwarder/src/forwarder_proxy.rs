    ...
    Gas: TxGas<Env>,
{
    ...
    >(
        self,
        index: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValue5<ManagedBuffer<Env::Api>, RewaOrDctTokenIdentifier<Env::Api>, u64, BigUint<Env::Api>, MultiValueManagedVec<Env::Api, ManagedBuffer<Env::Api>>>> {
        self.wrapped_tx
            .payment(NotPayable)
    ...
    >(
        self,
        to: Arg0,
    ) -> TxTypedCall<Env, From, To, (), Gas, MultiValue4<u64, u64, BigUint<Env::Api>, RewaOrDctTokenIdentifier<Env::Api>>> {
        self.wrapped_tx
    ...
    pub fn get_fungible_dct_balance<
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("getFungibleDctBalance")
            .argument(&token_identifier)
            .original_result()
    }
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("send_dct_direct_multi_transfer")
            .argument(&to)
            .argument(&token_payments)
            .original_result()
    }
    ...
    >(
        ...
        token_id: Arg1,
        nonce: Arg2,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValue9<DctTokenType, BigUint<Env::Api>, bool, ManagedBuffer<Env::Api>, ManagedBuffer<Env::Api>, ManagedBuffer<Env::Api>, ManagedAddress<Env::Api>, BigUint<Env::Api>, ManagedVec<Env::Api, ManagedBuffer<Env::Api>>>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("get_dct_token_data")
            .argument(&address)
            .argument(&token_id)
            .argument(&nonce)
            .original_result()
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("is_dct_paused")
            .argument(&token_id)
            .original_result()
    }

    pub fn is_dct_limited_transfer<
        Arg0: ProxyArg<TokenIdentifier<Env::Api>>,
    >(
        self,
        token_id: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("is_dct_limited_transfer")
            .argument(&token_id)
            .original_result()
    }
    ...
    pub fn set_local_roles<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<TokenIdentifier<Env::Api>>,
        Arg2: ProxyArg<MultiValueEncoded<Env::Api, DctLocalRole>>,
    >(
        self,
        address: Arg0,
        token_identifier: Arg1,
    ...
    Api: ManagedTypeApi,
{
    ...
    pub token_identifier: RewaOrDctTokenIdentifier<Api>,
    pub token_nonce: u64,
