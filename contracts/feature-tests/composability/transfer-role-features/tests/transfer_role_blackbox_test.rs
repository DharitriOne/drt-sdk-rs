...
impl TransferRoleTestState {
    fn new() -> Self {
        ...
        world
            ...
            .nonce(1)
            .dct_balance(TRANSFER_TOKEN, 1000);
    ...
    fn forward_payments(&mut self, dest: Address, endpoint_name: &[u8]) {
        self.world
            ...
            .rewa_or_single_dct(
                &RewaOrDctTokenIdentifier::dct(TRANSFER_TOKEN),
                0u64,
                &drt_sc::proxy_imports::BigUint::from(100u64),
            )
            .run();
    }
    ...
    fn check_user_and_vault_balance(&mut self) {
        self.world
            ...
            .dct_balance(TRANSFER_TOKEN, 800);
        self.world
            .check_account(VAULT_ADDRESS)
            .dct_balance(TRANSFER_TOKEN, 100);
    }
}
...
fn test_transfer_role() {
    ...
    state
        .world
        .check_account(USER_ADDRESS)
        .dct_balance(TRANSFER_TOKEN, 900);
