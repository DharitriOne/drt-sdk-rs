...
pub trait ForwarderRawCommon {
    ...
    fn callback_payments(&self) -> VecMapper<(RewaOrDctTokenIdentifier, u64, BigUint)>;

    #[view]
    fn callback_payments_triples(
        &self,
    ) -> MultiValueEncoded<MultiValue3<RewaOrDctTokenIdentifier, u64, BigUint>> {
    ...
    fn callback_payment_at_index(
        &self,
        index: usize,
    ) -> MultiValue3<RewaOrDctTokenIdentifier, u64, BigUint> {
