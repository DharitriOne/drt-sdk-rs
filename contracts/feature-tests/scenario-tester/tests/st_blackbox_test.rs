...
fn set_state_test() {
    ...
    world
        ...
        .nonce(3)
        .balance(50)
        .dct_nft_balance_and_attributes(NFT_ID, 2, 1, "")
        .commit();
    ...
    world
        ...
        .nonce(3)
        .balance(50)
        .dct_nft_balance_and_attributes(NFT_ID, 2, 1, FOURTH_ATTRIBUTES)
        .commit();
    ...
    world
        ...
        .nonce(2)
        .balance(30)
        .dct_nft_last_nonce(NFT_ID, 5);
    world
        .check_account(fifth)
        .nonce(2)
        .balance(30)
        .dct_nft_balance_and_attributes(NFT_ID, 5, 0, "");
