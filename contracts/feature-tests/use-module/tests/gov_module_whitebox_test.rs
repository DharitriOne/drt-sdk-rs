...
const USE_MODULE_PATH_EXPR: &str = "drtsc:output/use-module.drtsc.json";
    ...
    world.set_state_step(
        SetStateStep::new()
            .put_account(
                ...
                Account::new()
                    .nonce(1)
                    .dcdt_balance(GOV_TOKEN_ID_EXPR, INITIAL_GOV_TOKEN_BALANCE),
            )
...
pub fn propose(
    ...
    world.whitebox_call(
        ...
        ScCallStep::new()
            .from(proposer)
            .dcdt_transfer(GOV_TOKEN_ID, 0, gov_token_amount),
        |sc| {
...
fn test_change_gov_config() {
    ...
    world.whitebox_call_check(
        ...
        ScCallStep::new()
            ...
            .dcdt_transfer(GOV_TOKEN_ID, 0, "999")
            .no_expect(),
        |sc| {
    ...
    world.whitebox_call(
        ...
        ScCallStep::new()
            ...
            .dcdt_transfer(GOV_TOKEN_ID, 0, "200"),
        |sc| {
            sc.vote(proposal_id, VoteType::UpVote);
        },
    );
    ...
    world.check_state_step(CheckStateStep::new().put_account(
        FIRST_USER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(GOV_TOKEN_ID_EXPR, "300"),
    ));
    world.check_state_step(CheckStateStep::new().put_account(
        SECOND_USER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(GOV_TOKEN_ID_EXPR, "1"),
    ));
    world.check_state_step(CheckStateStep::new().put_account(
        THIRD_USER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(GOV_TOKEN_ID_EXPR, "800"),
    ));
    world.check_state_step(CheckStateStep::new().put_account(
        OWNER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(GOV_TOKEN_ID_EXPR, "800"),
...
fn test_down_veto_gov_config() {
    ...
    world.whitebox_call(
        ...
        ScCallStep::new()
            .from(FIRST_USER_ADDRESS_EXPR)
            .dcdt_transfer(GOV_TOKEN_ID, 0, "300"),
        |sc| {
            sc.vote(proposal_id, VoteType::UpVote);
        },
    );
    ...
    world.check_state_step(CheckStateStep::new().put_account(
        FIRST_USER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(GOV_TOKEN_ID_EXPR, "200"),
    ));
    world.check_state_step(CheckStateStep::new().put_account(
        SECOND_USER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(GOV_TOKEN_ID_EXPR, "800"),
...
fn test_abstain_vote_gov_config() {
    ...
    world.whitebox_call(
        ...
        ScCallStep::new()
            .from(FIRST_USER_ADDRESS_EXPR)
            .dcdt_transfer(GOV_TOKEN_ID, 0, "500"),
        |sc| {
            sc.vote(proposal_id, VoteType::UpVote);
        },
    );
    ...
    world.whitebox_call(
        ...
        ScCallStep::new()
            .from(SECOND_USER_ADDRESS_EXPR)
            .dcdt_transfer(GOV_TOKEN_ID, 0, "400"),
        |sc| {
            sc.vote(proposal_id, VoteType::DownVote);
        },
    );
    ...
    world.whitebox_call(
        ...
        ScCallStep::new()
            .from(THIRD_USER_ADDRESS_EXPR)
            .dcdt_transfer(GOV_TOKEN_ID, 0, "600"),
        |sc| {
    ...
    world.check_state_step(CheckStateStep::new().put_account(
        FIRST_USER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(GOV_TOKEN_ID_EXPR, "0"),
    ));
    world.check_state_step(CheckStateStep::new().put_account(
        SECOND_USER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(GOV_TOKEN_ID_EXPR, "600"),
    ));
    world.check_state_step(CheckStateStep::new().put_account(
        THIRD_USER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(GOV_TOKEN_ID_EXPR, "400"),
    ));
}
