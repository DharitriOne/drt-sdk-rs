...
fn test_token_merge() {
    ...
    let nft_transfers = vec![
        TxDCDT {
            dcdt_token_identifier: NFT_TOKEN_ID.into(),
            nonce: FIRST_NFT_NONCE.into(),
            dcdt_value: NFT_AMOUNT.into(),
        },
        TxDCDT {
            dcdt_token_identifier: NFT_TOKEN_ID.into(),
    ...
    world.whitebox_call(
        ...
        ScCallStep::new()
            ...
            .multi_dcdt_transfer(nft_transfers),
        |sc| {
    ...
    let dcdt_transfers = vec![
        ...
        TxDCDT {
            dcdt_token_identifier: FUNGIBLE_TOKEN_ID.into(),
            nonce: 0u64.into(),
            dcdt_value: FUNGIBLE_AMOUNT.into(),
        },
    ];
    ...
    world.whitebox_call(
        ...
        ScCallStep::new()
            .from(USER_ADDRESS_EXPR)
            .multi_dcdt_transfer(dcdt_transfers),
        |sc| {
            let merged_token = sc.merge_tokens_endpoint();
            assert_eq!(
                merged_token.token_identifier,
    ...
    let combined_transfers = vec![
        ...
        TxDCDT {
            dcdt_token_identifier: MERGED_TOKEN_ID.into(),
            nonce: 2u64.into(),
            dcdt_value: NFT_AMOUNT.into(),
        },
    ];
    ...
    world.whitebox_call(
        ...
        ScCallStep::new()
            .from(USER_ADDRESS_EXPR)
            .multi_dcdt_transfer(combined_transfers),
        |sc| {
            let merged_token = sc.merge_tokens_endpoint();
            assert_eq!(
                merged_token.token_identifier,
    ...
    world.check_state_step(CheckStateStep::new().put_account(
        USER_ADDRESS_EXPR,
        CheckAccount::new().dcdt_balance(FUNGIBLE_TOKEN_ID_EXPR, FUNGIBLE_AMOUNT),
    ));
}
