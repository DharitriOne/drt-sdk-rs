...
/// Adaptation of the EIP-5643 for DharitriOne, more here https://eips.ethereum.org/EIPS/eip-5643  
///
/// This standard is an extension of the DharitriOne NFT standard.
